...
<title>마이페이지 - 중고악기 작성 글</title>
	<script>
		...
		function goPage(){
			...
			let url = "/member/fleaMyWrite/?user_id=";
	...
	<div class="rem-20 my-top-15 my-bottom-15">
		...
		<div class="border-bottom" >
			<ul class="nav nav-tabs nav-justified">
				...
				<li><button type="button" id="myFleaBtn" class="myPageBtn" style="background-color:#A9D0F5;">중고악기</button></li>
		...
		<div class="content">
			...
			<table summary="중고악기 리스트" class="table ">
				...
				<tbody id = "list" class="">
					<c:choose>
						<c:when test="${ not empty fleaMyWrite }">
