	...
	<div class="rem-20 my-top-15 my-bottom-15">
		...
		<div class="py-2rem flex justify-right">
			<div class="items-center">
				<form id="searchForm">
					...
					<input type="hidden" id="poserUserName" name="user_name" value="${postUserName }">
		...
		<div class="border-bottom" >
			<ul class="nav nav-tabs nav-justified">
				<li><button type="button" id="comPosts" class="postBtn">커뮤니티</button></li>
				<li><button type="button" id="fleaPosts" class="postBtn" style="background-color:#CED8F6;">중고악기</button></li>
		...
		<div class="content">
			...
			<table summary="중고악기 리스트" class="table ">
				<thead>
					<tr>
						<th class="text-center col-md-3">제목</th>
						<th data-value="flea_date" class="order col-md-1 text-center">작성일</th>
						<th data-value="flea_hits" class="order col-md-1 text-center">조회수</th>
					</tr>
				</thead>
				<tbody id = "list" class="">
					<c:choose>
						<c:when test="${ not empty fleaPosts }">
							<c:forEach items="${fleaPosts }" var="fleaPost" varStatus="status">
								<tr class="text-center" data-num="${fleaPost.flea_no}">
									<td class="class">
										<a class="" href="/fleaMarket/board/${fleaPost.flea_no }">${fleaPost.flea_title}</a>
									</td>
									<td class="col-md-1 ">${fleaPost.flea_date}</td>
									<td class="col-md-1 ">${fleaPost.flea_hits }</td>
								</tr>
							</c:forEach>
						</c:when>
						<c:otherwise>
