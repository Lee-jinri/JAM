...
public class RoomRentalRestController {
	 ...
	 * 			성공 시 HttpStatus.OK를 반환하고 실패 시 HttpStatus.INTERNAL_SERVER_ERROR를 반환합니다.
	 **********************************/
	@RequestMapping(value="/board/{roomRental_no}", method=RequestMethod.POST)
	public ResponseEntity<String> boardDelete(@PathVariable("roomRental_no") Long roomRental_no) throws Exception{
