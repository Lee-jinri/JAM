...
public class JobRestController {
	 ...
	 * 			성공 시 HttpStatus.OK를 반환하고 실패 시 HttpStatus.INTERNAL_SERVER_ERROR를 반환합니다.
	 **********************************/
	@RequestMapping(value="/board/{job_no}", method=RequestMethod.DELETE)
	public ResponseEntity<String> boardDelete(@PathVariable("job_no") Long job_no) throws Exception{
